...
CREATE TABLE announcement_board (
    ...
    announcement_writer_id VARCHAR(50) NOT NULL,
    announcement_write_datetime DATETIME NOT NULL DEFAULT(now()),
    announcement_view_count INT NOT NULL DEFAULT(0),
    CONSTRAINT fk_announcement_board_writer_id FOREIGN KEY (writer_id) REFERENCES user (user_id)
);
## 트렌드 게시물 테이블 생성
...
CREATE TABLE qna_board (
    ...
    qna_board_writer_id VARCHAR(50) NOT NULL,
...
CREATE TABLE degsiner_board (
    ...
    degsiner_board_writer_id VARCHAR(50) NOT NULL,
